...
TEST_CASE("testing_aufgabe_6" , "[sorted_vector]")
{
    ...
    //Aufgabe 8
    std::sort(sorted_circles3.begin(), sorted_circles3.end(), std::less<Circle>());
